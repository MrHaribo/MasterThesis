...
\subsubsection{Hypothesis on Required Features}
...
be wrong. Granularity is the most challenging part of DDD
...
Usually logical composition is realized with an RESTful API description that
...
(PCG) was intended to be researched in greater detail. But since the topics
deployment and composition required a lot more effort than anticipated, the time
