...
in itself which allows a simple replacement of components. The components are
...
\autoref{fig:architecture_layers} shows the relation of the features and
all the components they contain.
...
of decentralized continuous delivery. But the tools feature also has the
