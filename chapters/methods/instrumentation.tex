...
reproduce the subjects during lab research (\autoref{sub:lab_reserach}). This
section contains an analysis of available technology along with a proposal on
how to choose between similar available technologies.
